 ...
 * Connection object or string. For details see {@link https://github.com/vitaly-t/pg-promise/wiki/Connection-Syntax Connection Syntax}.
 *
 * @param {} [dc]
 * Database Context.
 *
...
function Database(cn, dc, config) {
    ...
    function extend(ctx, obj) {
         ...
         *
         * @returns {external:Promise}
         * The same as method {@link Database.manyOrNone manyOrNone}
         *
         ...
         *     });
         *
         * // NOTE: pgp.helpers.update() can do a better-performing multi-row UPDATE.
         *
         */
